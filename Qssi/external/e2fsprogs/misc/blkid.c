 ...
 */
// BEGIN Lenovo, yangsq11, 2023/07/19, LGSIU-145, modify for SDcard's label shows incorrectly
/* @orig
...
int main(int argc, char **argv)
{
	...
	int lookup = 0, gc = 0;
	int c;
	// add for SDcard's label shows incorrectly
	int has_arg_x = 0;
	...
	*/
	...
	// END LGSIU-145
		...
		case 'w':
			write = optarg;
			break;
		/* add for SDcard's label shows incorrectly, begin */
		case 'x':
			has_arg_x = 1;
			break;
		/* add for SDcard's label shows incorrectly, end */
		case 'h':
			err = 0;
			/* fallthrough */
		default:
